...
export default function Brand({ className }: { className?: string }) {
    return (
        ...
        >
            ...
            <span role="tooltip" className="before:[border-right6px_solid_#1ca7ec] relative my-auto ml-3 rounded-md border-b border-l-0 bg-primary px-3 py-1 text-xs font-bold uppercase text-white before:absolute before:-left-1 before:top-[50%] before:block before:h-3 before:w-3 before:content-[''] before:[border-bottom:6px_solid_transparent] before:[border-right:6px_solid_#1ca7ec] before:[border-top:6px_solid_transparent] before:[transform:translate(-50%,-50%)]">
                Beta
            </span>
        </Link>
    );
